...
import "./CommonSubBannerClub.scss";
...
const CommonSubBannerClub: React.FC<ICommonSubBanner> = ({ link, title }) => {
  const router = useRouter();
  const { parentMenus, currentPageMenu } = usePageData();
  return (
    <section className="common-sub-banner-club-part">
      <div className="container">
        <div className="common-sub-banner-club">
          <h1>{title}</h1>
          <Breadcrumb parentMenus={parentMenus} link={link[0]} title={title} />
...
export default CommonSubBannerClub;
